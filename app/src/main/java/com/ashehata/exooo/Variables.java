...
public class Variables {
    ...
    public static String tag="lipsy_";
    ...
    public static String gif_api_key1="B7wBpHJTkt3S3hP0fmCouqG6OkfbtW8w";

    public static String privacy_policy="https://www.termsfeed.com/privacy-policy/4dec1a564a01ea0d15ed86c97c4e8253";


    public static String domain="http://lipsyapps.com/API/index.php?p=";
    public static String base_url="http://lipsyapps.com/API/";
